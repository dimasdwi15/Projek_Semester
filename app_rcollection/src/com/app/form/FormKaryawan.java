...
import com.app.JDialog.FormInputKaryawan;
...
public class FormKaryawan extends javax.swing.JPanel {
    ...
    private void tampilkanData() {
        ...
        while (rs.next()) {
            ...
            String cjenis = rs.getString("cjenis");
            String alamat = rs.getString("alamat");
            String level = rs.getString("level");
                
                // Add data to table
                model.addRow(new Object[]{id, nama, username, password, cjenis,alamat,level});
            }
    ...
    private void cariData(String keyword) {
        ...
        String sql = "SELECT * FROM tb_user WHERE id LIKE ? OR nama LIKE ? OR username LIKE ?";
    ...
    private void tambahKaryawan() {
        FormInputKaryawan formInput = new FormInputKaryawan(null);
    ...
    private void perbaruiKaryawan() {
        ...
        String username = tbl_data.getValueAt(selectedRow, 2).toString();
        String password = tbl_data.getValueAt(selectedRow, 3).toString();
        String cjenis = tbl_data.getValueAt(selectedRow, 4).toString();
        String alamat = tbl_data.getValueAt(selectedRow, 5).toString();
        String level = tbl_data.getValueAt(selectedRow, 6).toString();
        
        // Create Member object to pass to input form
        Karyawan selectedKaryawan = new Karyawan(id, nama, username,password, cjenis ,alamat,level);
        
         // Open input form with selected member data
        FormInputKaryawan formInput = new FormInputKaryawan(selectedKaryawan);
        formInput.setLocationRelativeTo(this);
        formInput.setVisible(true);
       // showFormInputSupplier(selectedSupplier);
    ...
    public Karyawan(String id, String nama, String username, String password, String cjenis, String alamat, String level) {
        this.id = id;
        this.nama = nama;
