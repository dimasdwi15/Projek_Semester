...
public class FormSupplier extends javax.swing.JPanel {
    ...
    private void tampilkanData() {
        ...
        String sql = "SELECT * FROM tb_supplier ORDER BY kode_supplier";
    ...
    private void hapusData() {
        ...
        if (konfirmasi == JOptionPane.YES_OPTION) {
            String sql = "DELETE FROM tb_supplier WHERE kode_supplier=?";
    ...
    private void tambahSupplier() {
        FormInputSupplier formInput = new FormInputSupplier(null);
    ...
    private void perbaruiSupplier() {
        ...
        java.util.Date tanggal = (java.util.Date) tbl_data.getValueAt(selectedRow, 4);
        
        // Create Member object to pass to input form
        Supplier selectedSupplier = new Supplier (id, nama, nomor,alamat, tanggal);
        
          // Open input form with selected member data
        FormInputSupplier formInput = new FormInputSupplier(selectedSupplier);
        formInput.setLocationRelativeTo(this);
        formInput.setVisible(true);
       // showFormInputSupplier(selectedSupplier);
        ...
        private void showFormInputSupplier(Supplier supplier) {
            FormInputSupplier formInput = new FormInputSupplier(supplier);
            formInput.setLocationRelativeTo(null); // Tampilkan di tengah layar
            formInput.setVisible(true);
