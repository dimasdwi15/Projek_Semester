...
public class FormInputSupplier extends javax.swing.JDialog {
     ...
     */
   public FormInputSupplier(FormSupplier.Supplier supplier) {
        ...
        if (isEditMode) {
            ...
            txt_nomor.setText(supplier.getNomor());
            txt_alamat.setText(supplier.getAlamat());
            tanggal.setDate(supplier.getTanggal());
    ...
    private void generateNewId() {
        try (Connection conn = getConnection();
            ...
            String sql = "SELECT COALESCE(MAX(CAST(RIGHT(kode_supplier, 3) AS UNSIGNED)), 0) + 1 FROM tb_supplier";
            ...
            if (rs.next()) {
                ...
                txt_id.setText("S001"); // If no data, start from M001
            }
    ...
    private void simpanData() {
        ...
        if (id.isEmpty() || nama.isEmpty() || nomor.isEmpty() || alamat.isEmpty() || tanggalDate == null) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormInputSupplier dialog = new FormInputSupplier(null);
