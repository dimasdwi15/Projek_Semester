...
public class MenuItem extends JPanel {
    ...
    public MenuItem(Menu menu, String menus[], int menuIndex, List<MenuEvent> events) {
        ...
        this.events = events;
        init();
        setBackground(new Color(0x7D6329)); // untuk background utama

    }

 private Icon getIcon() {
    String[] iconNames = {
        "/com/app/icon/dashboard.fix.png",
        "/com/app/icon/Data.png",
        "/com/app/icon/Transaksi.png",
        "/com/app/icon/Laporan.png",
        "/com/app/icon/Logout.png",

    };

    if (menuIndex >= 0 && menuIndex < iconNames.length) {
        java.net.URL imgURL = getClass().getResource(iconNames[menuIndex]);
        if (imgURL != null) {
    ...
    return new javax.swing.ImageIcon(); // fallback kosong
}
   ...
   private JButton createButtonItem(String text) {
    ...
    button.putClientProperty(FlatClientProperties.STYLE, ""
            + "background:#7D6329;"
           + "foreground:#FFFFFF;" // Ubah di sini jadi putih
            + "selectedBackground:#B18328;"
